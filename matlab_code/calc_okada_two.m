function [ux, uy, uz] = calc_okada_two(HF, U1,U2, x, y, nu, delta, d, len, W, fault_type, strike, tp)
...
[f1a, f2a, f3a,g1a,g2a,g3a] = fBi_fast(rotx + L, p    , parvec, p, q);
[f1b, f2b, f3b,g1b,g2b,g3b] = fBi_fast(rotx + L, p - W, parvec, p, q);
[f1c, f2c, f3c,g1c,g2c,g3c] = fBi_fast(rotx - L, p    , parvec, p, q);
[f1d, f2d, f3d,g1d,g2d,g3d] = fBi_fast(rotx - L, p - W, parvec, p, q);

% --- displacement equations
% --- strike ---
ux1 = Const * (f1a - f1b - f1c + f1d) * U1;
uy1 = Const * (f2a - f2b - f2c + f2d) * U1;
uz1 = Const * (f3a - f3b - f3c + f3d) * U1;

% --- dip ---
ux2 = Const * (g1a - g1b - g1c + g1d) * U2;
uy2 = Const * (g2a - g2b - g2c + g2d) * U2;
uz2 = Const * (g3a - g3b - g3c + g3d) * U2;
...
function [f1, f2, f3,g1,g2,g3] = fBi_fast(sig, eta, parvec, p, q)
...
% end
        ...
        f3 = dqORReta   + (sd .* qOReta) + I4 .* sd;
        g1 = q ./ R - I3 .* cssd;
        g2 = yqORRsig + cd .* theta - I1 .* cssd;
        g3 = dqORRsig + sd .* theta - I5 .* cssd;
end