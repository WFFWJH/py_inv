function make_insar_data(track,npt,region,Nmin,Nmax,varargin)
...
%  
   ...
   [xout,yout,zout,~,rms_out,xx1,xx2,yy1,yy2]=make_insar_downsample(xin,yin,losin,this_npt,Nmin(k),Nmax(k),'mean');
