function zout=slip2AZO_okada(XIN,YIN,zin,look_e,look_n,slip_model_in)
%
%  Usage: 
...
for k=1:Npatch
   ...
   strike=strkp(k)*d2r;
   tp=zeros(size(xpt));
   [ue1,un1,~]=calc_okada(HF,U1,xpt,ypt,nu,delta,d,len,W,fault_type1,strike,tp);
   [ue2,un2,~]=calc_okada(HF,U2,xpt,ypt,nu,delta,d,len,W,fault_type2,strike,tp);
   uE1=uE1+ue1;
   uN1=uN1+un1;
